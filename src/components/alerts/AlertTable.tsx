              ...
              <TableRow key={alert.id}>
                <TableCell>
                  <span className={cn(
                    ...
                    severityStyles[alert.severity as keyof typeof severityStyles]?.bg,
                    severityStyles[alert.severity as keyof typeof severityStyles]?.text
                  )}>
                    {alert.severity.toUpperCase()}
                  </span>
                </TableCell>
                <TableCell>{formatTimestamp(alert.timestamp)}</TableCell>
                <TableCell>{alert.alert_source || alert.source || 'System'}</TableCell>
